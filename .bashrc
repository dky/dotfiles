...
export PATH=$HOME/bin:$HOME/.dotfiles/bin:$HOME/go/bin:/usr/local/sbin:/usr/local/go/bin:$HOME/.local/bin:/usr/local/opt/llvm/bin:$HOME/.yarn/bin:/opt/homebrew/bin:$HOME/.cargo/bin:$HOME/.tfenv/bin:$PATH
