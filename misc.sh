...
npm install coc-css coc-dictionary coc-eslint coc-go coc-html coc-json coc-neosnippet coc-prettier coc-pyright coc-python coc-tsserver coc-vetur coc-yaml --global-style --ignore-scripts --no-bin-links --no-package-lock --only=prod
